...
export function ColumnConfig() {
    return new Array(React.useMemo(
        () => [
            {
                ...
                Cell: e => e.row.original.read ?
                    <Link to={EDICON_DETAILS_OVERVIEW_URL(e.row.original.id)}> {e.value} </Link>
                    : <Link to={EDICON_DETAILS_OVERVIEW_URL(e.row.original.id)}> <b>{e.value}</b> </Link>
            },
            {
