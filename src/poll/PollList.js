...
//     }
//
//     loadPollList(pageNumber = 0, pageSize = EDI_LIST_SIZE) {
//         let promise;
//         if(this.props.username) {
//             if(this.props.type === 'USER_CREATED_POLLS') {
//                 promise = getUserCreatedPolls(this.props.username, pageNumber, pageSize);
...
//
//     handleLoadMore() {
//         this.loadPollList(this.state.pageNumber + 1);
//     }
//
